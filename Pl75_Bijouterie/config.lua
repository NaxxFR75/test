    ...
    ['painting'] = {
        {
            ...
            paintingPrice = '2500', -- price of the reward item for sell
...
Strings = {
    ['start_heist'] = 'Appuyez sur ~INPUT_CONTEXT~ pour démarrer Vangelico Heist',
    ['goto_vangelico'] = 'Allez à l\'emplacement dans le GPS. Jetez une bombe lacrymogène dans le conduit de ventilation.',
    ['wait_nextrob'] = 'Tu dois attendre aussi longtemps pour te déshabiller à nouveau.',
    ['minute'] = 'minute.',
    ...
    ['cute_down'] = 'Appuyez sur ~INPUT_CONTEXT~ pour couper',
    ['glass_cut'] = 'Appuyez sur ~INPUT_CONTEXT~ pour couper la vitre', 
    ['smash'] = 'Appuyez sur ~INPUT_CONTEXT~ pour casser la vitre',
    ['throw_gas_blip'] = 'Lancer du gaz',
    ['good_shot'] = 'Bon tir! Attendez que les initiés s\'évanouissent. N\'oubliez pas de mettre un masque !',
    ['need_switchblade'] = 'Vous avez besoin du switchblade.',
    ['need_rifle'] = 'Vous avez besoin du fusil.',
    ['need_this'] = 'Tu en as besoin: ',
    ['deliver_to_buyer'] = 'Livrez le butin à l\'acheteur. Vérifier le GPS.',
    ['buyer_blip'] = 'Acheteur',
    ['need_police'] = 'Pas assez de policiers dans la ville.',
    ['total_money'] = 'Tu as ça: ',
    ['police_alert'] = 'Alerte au cambriolage du magasin Vangelico ! Vérifiez votre GPS.',
}
