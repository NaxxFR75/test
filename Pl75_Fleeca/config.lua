...
Config['FleecaMain'] = {
    ...
    rewardItems = {
        diamondTrolly = { 
            ...
            sellPrice = 150, -- for buyer sell price
        },
        goldTrolly = { 
            item = 'gold', 
            count = 1,
        ...
        cashTrolly = { 
            item = nil, -- cash
            count = 100,
            multiGrabCount = 15000, -- middle main grab
        },
        lockbox = function()
...
Config['FleecaHeist'] = {
    [1] = {
        scenePed = { model = 'csb_tomcasino', coords = vector3(-2958.6960449219,481.08209228516,15.697017669678), heading = 269.4880065917969}, -- ped settings
    ...
    [2] = {
        scenePed = { model = 'csb_tomcasino', coords = vector3(1176.6865234375,2710.6640625,38.08797454834), heading = 2.19647169113159},
    ...
    [3] = {
        scenePed = { model = 'csb_tomcasino', coords = vector3(-353.9186706543,-53.001174926758,49.036521911621), heading = 170.1770477294922},
    ...
    [4] = {
        scenePed = { model = 'csb_tomcasino', coords = vector3(311.72189331055,-283.42977905273,54.164752960205), heading = 76.59477996826172},
    ...
    [5] = {
        scenePed = { model = 'csb_tomcasino', coords = vector3(-106.03485107422,6471.0952148438,31.626720428467), heading = 226.8193511962891},
    ...
    [6] = {
        scenePed = { model = 'csb_tomcasino', coords = vector3(146.92742919922,-1043.8546142578,29.368017196655), heading = 155.95530700683597},
...
Strings = {
    ['wait_nextheist'] = 'Tu dois attendre pour faire un second braquage',
    ['minute'] = 'minute.',
    ['need_item'] = 'Tu en as besoin: ',
    ['police_alert'] = 'Alerte au braquage de banque Fleeca ! Vérifiez votre GPS.',
    ['drill'] = 'Appuyer sur ~INPUT_CONTEXT~ pour utiliser la perceuse',
    ['grab_trolly'] = 'Press ~INPUT_CONTEXT~ pour prendre un chariot',
