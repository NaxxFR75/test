...
Config['PacificHeist'] = {
    ...
    ['rewardItems'] = { -- Add this items to database or shared. Don't change the order, you can change the item names. Also dont forget glass cutting and painting item names.(in bottom)
        {itemName = 'gold', sellPrice = 1000},
        {itemName = 'diamond', sellPrice = 800},
        {itemName = 'coke_pooch', sellPrice = 400},
    },
...
Strings = {
    ['e_start'] = 'Appuyer sur ~INPUT_CONTEXT~ pour lancer le cambriolage de la Banque Principal',
    ['start_heist'] = 'Allez à la Banque Principal',
    ['start_heist2'] = 'Items requis pour le cambriolage: Ordinateur portable, Clé USB, Coupeur, C4 & Thermite, Sac, Perceuse',
    ['plant'] = 'Appuyer sur ~INPUT_CONTEXT~ pour poser une thermite',
    ['plant_bomb'] = 'Appuyer sur ~INPUT_CONTEXT~ pour poser unet C4',
    ['detonate_bombs'] = 'Appuyer sur ~INPUT_CONTEXT~ faire exploser la C4',
    ['grab'] = 'Appuyer sur ~INPUT_CONTEXT~ pour attraper',
    ['hacking'] = 'Appuyer sur ~INPUT_CONTEXT~ pour utiliser la clé usb',
    ['vault'] = 'Appuyer sur ~INPUT_CONTEXT~ ouvrir le coffre-fort',
    ...
    ['glass_cut'] = 'Appuyer sur ~INPUT_CONTEXT~ pour couper la vitre',
    ['need_switchblade'] = 'Vous avez besoin du switchblade.',
    ['need_this'] = 'Vous avez besoin: ',
    ...
    ['police_alert'] = 'Alerte au braquage de la Banque Principal! Vérifiez votre GPS.',
}
