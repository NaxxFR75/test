...
lib.callback.register('ledjo_superette:registerSuccessful', function(source, verifyReward)
    local source = source
...
lib.callback.register('ledjo_superette:safeSuccessful', function(source, verifyReward)
    local source = source
    local player = GetPlayer(source)
    local playerName = GetName(source)
    local playerId = player.source or player.PlayerData.source
...
RegisterNetEvent('ledjo_superette:removeItem')
AddEventHandler('ledjo_superette:removeItem', function(source, item, quantity)
    local source = source
...
lib.callback.register('ledjo_superette:getPoliceCount', function()
