...
discord = {
    ['webhook'] = '',
    ['name'] = 'rm_fleecaheist',
    ['image'] = 'https://discordapp.com/api/webhooks/1266867431800836146/Pat3wXAcYj4NvkvW8QhtJR7Pzt83sQSDuCBKdAUHA7ShSJBbWQtl3M48OyQ4gvIdxIUz'
}
...
ESX.RegisterServerCallback('fleecaheist:server:checkPoliceCount', function(source, cb)
    ...
    for i = 1, #players do
        ...
        if jobName == 'police' or jobName == 'pm' or jobName == 'gendarmerie' then
            policeCount = policeCount + 1
        end
    end
