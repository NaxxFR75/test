...
AddEventHandler('stoleItems', function(data)
    ...
    if robbedItems[data.args] == nil then
        ...
        TriggerServerEvent('treespacemaison:stoleItems')
        animation = false
    else
        lib.notify({
            title = 'Combriolage',
...
AddEventHandler('joinInstance', function(data)
    ...
    if exports.ox_inventory:Search('count', 'lockpick') > 0 and robbedHouses[data.args[4]] == nil then 
        ...
        TriggerServerEvent('treespacemaison:removeLockpick')
        ...
        if success then
            ...
            DoScreenFadeOut(500)
            Wait(500)
            TriggerServerEvent('treespacemaison:joinInstance', data.args[1])
...
AddEventHandler('leaveInstance', function(data)
    ...
    DoScreenFadeOut(500)
    Wait(500)
    TriggerServerEvent('treespacemaison:leaveInstance')
