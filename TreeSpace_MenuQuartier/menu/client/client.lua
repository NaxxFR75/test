...
local function getPlayerInv(player)
	...
	ESX.TriggerServerCallback('quartier:getOtherPlayerData', function(data)
         ...
         Citizen.CreateThread(function()
             while open do 
					   RageUI.IsVisible(MenuCitoyens, function()
						...
						RageUI.Button("~h~~b~[GESTION]~s~~h~ Fouiller une personne", "Fouille la personne en face de vous", {RightLabel = "→→"}, true , {
							onActive = function()
