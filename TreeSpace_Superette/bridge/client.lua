...
PoliceDispatch = function(data)
    ...
    elseif Config.Dispatch == 'qs-dispatch' then
        ...
        TriggerServerEvent('qs-dispatch:server:CreateDiapatchCall', {
            ...
            callCode = { code = 'Alerte', snippet = 'Superette' },
    ...
    elseif Config.Dispatch == 'LeDjo_Dispatch' then
        ...
        local ATMRobbery = {
            ...
            job = {"police", "gendarmerie", "pm"} -- Modifier ici pour inclure les deux jobs
        }
