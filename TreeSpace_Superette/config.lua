...
Config.PoliceCount = 3 
Config.PoliceJobs = { 'police', 'gendarmerie', 'pm' }
Config.Dispatch = 'LeDjo_Dispatch' 
...
Config.RegisterInput = { 'Z', 'Q', 'S', 'D' } -- Les clés utilisées pour le mini-jeu de contrôle de compétences peuvent être n'importe quelle clé.
...
Config.RegisterRewardMinQuantity = 1500 -- Si RegisterRewardRandom = true alors c'est la quantité minimale, sinon peut être ignorée
Config.RegisterRewardMaxQuantity = 3500 -- Si RegisterRewardRandom = true alors c'est la quantité maximale, sinon peut être ignorée
...
Config.SafeRewardQuantity = 1000 --  Si RegisterRewardRandom = false alors c'est la quantité récompensée, si vrai alors peut être ignoré
Config.SafeRewardMinQuantity = 1500 -- Si RegisterRewardRandom = true alors c'est la quantité minimale, sinon peut être ignorée
Config.SafeRewardMaxQuantity = 3500 -- Si RegisterRewardRandom = true alors c'est la quantité maximale, sinon peut être ignorée
...
Config.ComputerInput = { 'Z', 'Q', 'S', 'D' } -- Les clés utilisées pour le mini-jeu de contrôle de compétences peuvent être n'importe quelle clé.
...
Config.Locations = {
    Registers = {
        ...
        vector3(-523.21826171875, 7561.9868164062, 6.5239996910095),
        vector3(-1227.3525390625, 6927.9130859375, 20.47508430481),
        vector3(-380.57476806641, 7205.84765625, 18.221366882324),
    ...
    Computers = {
        ...
        vector3(-523.04888916016, 7564.1088867188, 6.5239996910095),
        vector3(-1227.498046875, 6936.3344726562, 20.47508430481),
        vector3(-375.23181152344, 7201.8579101562, 18.221385955811),
    ...
    Safes = {
        ...
        vector3(-525.50152587891, 7561.7661132812, 6.524001121521),
        vector3(-1227.1558837891, 6937.6967773438, 20.47508430481),
        vector3(-374.7658996582, 7203.31640625, 18.221382141113),
