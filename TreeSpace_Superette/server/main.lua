...
lib.callback.register('treespace_superette:registerSuccessful', function(source, verifyReward)
    local source = source
...
lib.callback.register('treespace_superette:safeSuccessful', function(source, verifyReward)
    local source = source
    local player = GetPlayer(source)
    local playerName = GetName(source)
    local playerId = player.source or player.PlayerData.source
...
RegisterNetEvent('treespace_superette:removeItem')
AddEventHandler('treespace_superette:removeItem', function(source, item, quantity)
    local source = source
...
lib.callback.register('treespace_superette:getPoliceCount', function()
