...
Config['TrainHeist'] = {
    ...
    ['reward'] = {
        ...
        sellPrice = 300 -- buyer sell price
    },
...
Strings = {
    ...
    ['goto_ambush'] = 'Allez au point d\'embuscade dans le GPS, pensez à avoir un cutter & un sac..',
    ['wait_nextrob'] = 'Vous dezvez attendre pour faire un second braquage',
    ['minute'] = 'minute.',
    ['ambush_blip'] = 'Point d\'embuscade',
    ['need_this'] = 'Vous en avez besoin: ',
    ['deliver_to_buyer'] = 'Livrez le butin à l\'acheteur. Vérifiez le GPS.',
    ['buyer_blip'] = 'Acheteur',
    ['need_police'] = 'Pas assez de policiers dans la ville.',
    ['total_money'] = 'Vous avez reçu :',
