...
const SHAPES = ["carré", "triangle", "rectangle", "rond"]
...
const QUESTIONS = {
    'Couleur d’arrière-plan' : (d) => d.colors['background'],
    'Couleur écrite' : (d) => d.colors['text'],
    'Couleur du nombre' : (d) => d.colors['number'],
    'Couleur de la forme' : (d) => d.colors['shape'],
    'Couleur du texte' : (d) => d.text[0],
    'Texte au-dessus de la couleur' : (d) => d.text[1],
    'Forme sous le texte' : (d) => d.shape
}
