...
async function start(){
    ...
    // mock loading screen
    setInformationText('RELIER')
    await delay(1.1)
    setInformationText('VÉRIFIER...')
    await delay(1.3)
    setInformationText('VÉRIFICATION REQUISE...')
    await delay(1.8)
    ...
    // display result
    setInformationText((result) ? 'Le système a accepté les réponses' : "Le système n’a pas accepté la réponse")
