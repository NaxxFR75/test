...
export function getPuzzleSvg(puzzleData){
    ...
    const numberText = createText(puzzleData.number, puzzleData.colors['number'], 60, 100, 50, 'Poppins, sans-serif')
...
const SHAPE_SVG = {
    "carré" : (c) => `<rect fill=${c} stroke="#000" stroke-width="1" width="150" height="150"/>`, 
